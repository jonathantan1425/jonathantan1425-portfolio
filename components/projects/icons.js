...
const ICONS = {
  "React": LogoReactIcon(SIZE),
  "Next.js": NextjsIcon(SIZE),
  "Node.js": NodejsIcon(SIZE),
  "Java": JavaIcon(SIZE),
  "Spring Boot": SpringBootIcon(SIZE),
...
// icon:logo-react | Ionicons https://ionicons.com/ | Ionic Framework
function LogoReactIcon(size, props) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="#61DBFB"
...
function NextjsIcon(size, props) {
  return (
    <svg 
      fill="none"
      viewBox="0 0 15 15"
...
function NodejsIcon(size, props) {
  return (
    <svg 
      fill="none"
      viewBox="0 0 15 15"
...
// icon:java | Devicons https://vorillaz.github.io/devicons/#/main | Theodore Vorillas
function JavaIcon(size, props) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="currentColor"
...
function SpringBootIcon(size, props) {
  return (
    <svg
      width={size}
      height={size}
...
function PythonIcon(size, props) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="currentColor"
...
function FastApiIcon(size, props) {
  return (
    <svg
      fill="none"
      height={size}
...
export function GithubIcon(size, color, props) {
  if (color === "light") {
    ...
    var style = "fill-ivory dark:fill-dark_gray hover:fill-mint dark:hover:fill-mint duration-300";
  }
  return (
    <svg
